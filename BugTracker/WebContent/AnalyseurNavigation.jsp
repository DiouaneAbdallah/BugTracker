...
<nav class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
          <div class="navbar-header"><a href="Analyseur.jsp" class="navbar-brand"></a></div>
            ...
            <ul class="nav navbar-nav navbar-right be-user-nav">
              ...
              <span class="user-name"></span></a>
                <ul role="menu" class="dropdown-menu">
                  ...
                  <li><a href="AnalyseurProfil.jsp"><span class="icon mdi mdi-face"></span> Profil</a></li>
                  <li><a href="AnalyseurProfilEdit.jsp"><span class="icon mdi mdi-edit"></span>Modifier mon profil</a></li>
                  <li><a href="logout"><span class="icon mdi mdi-power"></span> Déconnexion</a></li>
                </ul>
              </li>
            </ul>
            <div class="page-title"><span>Analyseur Dashboard</span></div>
      ...
      <div class="be-left-sidebar">
        <div class="left-sidebar-wrapper"><a href="Analyseur.jsp" class="left-sidebar-toggle">Analyseur Dashboard</a>
          <div class="left-sidebar-spacer">
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  <li class="active"><a href="Analyseur.jsp"><i class="icon mdi mdi-home"></i><span>Dashboard</span></a>
                  </li>
                  
                  <li class="parent"><a href="#"><i class="icon mdi mdi-bug"></i><span>Analyser les Bogues</span></a>
                    <ul class="sub-menu">
                      <li><a href="Analyseur.jsp#bugs">Analyser un bogue</a></li>
                    </ul>
                  </li>
