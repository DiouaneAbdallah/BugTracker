...
<div class="row" id="bugs">
   	...
   	<div class="col-lg-12">
            ...
            <div class="panel-heading">Les informations du bogue (DUPLIQUE)</div>
				...
				<TR>
					<th>Commentaire de l'analyseur</th>
            	...
            	<%
            		...
            		System.out.println("Affichage du details de bug - FIXING.JSP- - DEVELOPPEUR "+e);
            	}
...
<div class="col-lg-12">
	...
	<div class="panel panel-default">
		...
		<div class="row">
                                <div class="col-lg-12">
                                    <form role="form" method="post" action="Fixed" data-parsley-validate>
