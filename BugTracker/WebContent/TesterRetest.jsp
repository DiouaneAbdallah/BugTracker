...
<html lang="en">
  <head>
    ...
    <title>Retester le projet</title>
...
<div class="row" id="bugs">
   	...
   	<div class="col-lg-12">
            ...
            <div class="panel-heading">Les informations du Bogue</div>
				...
				<TR>
					<th>Commentaire de developpeur</th>
            	...
            	<%
            		...
            		System.out.println("Affichage du details de bug - RETEST.JSP- - DEVELOPPEUR "+e);
            	}
...
<div class="col-lg-12">
	...
	<div class="panel panel-default">
		...
		<div class="panel-heading">Est Ce Que Le bogue Est résolu :</div>

		<div class="panel-body">
		
		<div class="row">
                   <div class="col-lg-6">
                         <form action="testvalide" method="post">
        				
        				
        							<div class="form-group">
                                        <label>Commentaire</label><br>
                                        
                                        <div style="margin:5px 0;padding:3px;"><textarea name="comment" rows="8" cols="100" style="width:100%;" placeholder="Saisir Un Commentaire"></textarea></div> <br>
                                    
                                    </div>
        				
        				
        				
        					<input name="id_bug" type="hidden" value="<%= Integer.parseInt((String)session.getAttribute("id_bug"))%>">
        					
        					<button class="btn btn-primary">Le bogue est résolu</button>
                                 ...
                                 <div class="col-lg-6">
                         <form action="testinvalide" method="post">
        					...
        					<button class="btn btn-primary">le bogue n'est pas résolu</button>
