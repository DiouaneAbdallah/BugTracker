...
<html lang="en">
  <head>
    ...
    <title>Developpeur profile</title>
                ...
                <div class="user-display">
                  ...
                  <div class="user-display-bottom">
                    ...
                    <div class="row user-display-details">
                      <div class="col-xs-6">
                        <div class="title">Projet(s) que je développe !</div>
                        <div class="counter"><% PreparedStatement pstmt4=con.prepareStatement("select count(*) from projet_dev where dev_id="+id); ResultSet res4=pstmt4.executeQuery();if(res4.next()) out.print(res4.getInt(1)); %></div>
                      </div>
                      <div class="col-xs-6">
                        <div class="title">Bugs pour resoudre !</div>
                        <div class="counter"><% PreparedStatement pstmt3=con.prepareStatement("select count(*) from user_bug where id_dev="+id); ResultSet res3=pstmt3.executeQuery(); if(res3.next()) out.print(res3.getInt(1)); %></div>
                      </div>
